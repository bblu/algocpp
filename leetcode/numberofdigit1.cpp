...
Total Accepted: 22153
Total Submissions: 84989
Difficulty: Hard
...
public:
    int countDigitOne(int n) {
        int left=n, base = 1,cur=0,right=0;
		int num = 0;
    ...
    void getLastButOne(int n,int l,int &c){
        if(n<10){
            c++;
            return;
        }
...
int main(){
	Solution sol;
	int c = sol.countDigitOne(21);

	printf("count of digit one is %d\n",c);
